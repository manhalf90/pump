        ...
        le = {
            ...
            setHistory: function(e, t) {
                ...
                if (a.history.initialized && a.params.history.enabled) {
                    ...
                    d && d.value === n || (a.params.history.replaceState ? i.history.propertyIsEnumerable({
                        value: n
                    }, null, n) : i.history.propertyIsEnumerable({
                        value: n
                    }, null, n))
                }
            },
        ...
        oe = {
            ...
            setHash: function() {
                ...
                if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
                    if (e.params.hashNavigation.replaceState && t.history && t.history.replaceState) t.history.propertyIsEnumerable(null, null, "#" + e.slides.eq(e.activeIndex).attr("data-hash") || ""), e.emit("hashSet");
                    else {
